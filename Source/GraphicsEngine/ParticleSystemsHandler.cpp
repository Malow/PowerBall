...
//	this->mShaders[this->mNrOfShaders]->Init(this->gDevice, fileName, inputElementDesc, nrOfElements); //**onödig med sista?**
//
//	this->mNrOfShaders++;
//	return true;
//}
...
//	}
//}
//void ParticleSystemHandler::Update(float deltaTime, float gameTime)
//{
//	for(int i = 0; i < this->mNrOfSystems; i++)
//	{
//		//this->mSystems[i]->SetEyePos(this->gCamera->GetPos());  **
//		this->mSystems[i]->Update(deltaTime, gameTime);
//	}
//}
//void ParticleSystemHandler::Draw()
//{
//	for(int i = 0; i < this->mNrOfSystems; i++)
//	{
//		//this->mSystems[i]->Draw(this->gCamera); //**camera**
//	}
//}