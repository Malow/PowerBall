...
void MainMenu::CreateOnlineAndLanMenu()
{
	...
	*/
	...
	tempElement = new TextBox(offSet + dx * (395.0f / 1200.0f), windowHeight * (80.0f / 900.0f), 1, "Media/Menus/TextBox300x30.png", dx * (310.0f / 1200.0f), windowHeight * (30.0f / 900.0f), "CTF Server", "ServerName", 0.75f, 20, NORMALCHAR_NR);
	this->mSets[OPTIONS_LAN_SUBCTF].AddElement(tempElement);
	...
	tempElement = new TextBox(offSet + dx * (395.0f / 1200.0f), windowHeight * (80.0f / 900.0f), 1, "Media/Menus/TextBox300x30.png", dx * (310.0f / 1200.0f), windowHeight * (30.0f / 900.0f), "KOTH Server", "ServerName", 0.75f, 20, NORMALCHAR_NR);
	this->mSets[OPTIONS_LAN_SUBKOTH].AddElement(tempElement);
	...
	tempElement = new TextBox(offSet + dx * (395.0f / 1200.0f), windowHeight * (80.0f / 900.0f), 1, "Media/Menus/TextBox300x30.png", dx * (310.0f / 1200.0f), windowHeight * (30.0f / 900.0f), "WARLOCK Server", "ServerName", 0.75f, 20, NR);
	this->mSets[OPTIONS_LAN_SUBWARLOCK].AddElement(tempElement);
